...
<%-- -------------------------------- Main Content ------------------------------ --%>
<main class="container pt-4 pb-5 d-flex flex-column gap-4">
    <nav class="nav justify-content-start align-items-center">
        <div class="dropdown-container">
            <div class="dropdown category-dropdown bg-secondary-subtle rounded-5 py-2 px-3 z-3">
    ...
    <!-- Business Banner -->
    <div class="business-banner p-4 rounded d-flex justify-content-around align-items-center flex-wrap gap-3">
        <div>
